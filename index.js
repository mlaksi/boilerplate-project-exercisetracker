...
app.post("/api/users/:_id/exercises", async (req, res) => {
  try {
    ...
    const exercise=await database.collection("exercises").findOne({userid:user._id});

    res.json({username:exercise.username,description:exercise.description,duration:parseInt(exercise.duration),date:exercise.date,_id:exercise.userid});
  } catch (err) {
    console.log(err);
